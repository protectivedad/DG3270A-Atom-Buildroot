...
ifeq ($(BR2_PACKAGE_RPCBIND_LEGACY),y)
define RPCBIND_LINK_LEGACY
	ln -fsr $(TARGET_DIR)/usr/bin/rpcbind $(TARGET_DIR)/usr/bin/portmap
endef
RPCBIND_POST_INSTALL_TARGET_HOOKS += RPCBIND_LINK_LEGACY
endif
endif
